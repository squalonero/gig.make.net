...

{
...

    {
        ...
        {
            $insertData = Session::get('arrayOrdine');
            $insertData['nome'] = ucwords($insertData['nome']);
            $insertData['cognome'] = ucwords($insertData['cognome']);

            $lastId = DB::table('ordinis')->insertGetId($insertData);
