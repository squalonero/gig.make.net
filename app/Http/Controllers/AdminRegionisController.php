<?php namespace App\Http\Controllers;
	...
	class AdminRegionisController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Regione","name"=>"regione"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Regione','name'=>'regione','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
