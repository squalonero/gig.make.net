...
return [
    ...
    */
    ...
    'NAME_FIELDS_CANDIDATE' => 'societa,divisione,filiale,name,nama,person_name,person,fullname,full_name,nickname,nick,nick_name,title,judul,content',
    ...
    'DEFEAULT_UPLOAD_MAX_SIZE' => 5000, //in KB
